    ...
    <SplitPaneStyled>
      <SplitPane style={{pointerEvents:"none",background:"transparent"}}  split="vertical" onChange={(sizes)=>this.onChange(sizes,'lr')}>
        ...
        <SplitPane style={{pointerEvents:"none",background:"transparent"}} split="horizontal"  onChange={(sizes)=>this.onChange(sizes,'tb')}>
          ...
          <Pane style={{pointerEvents:"auto",background:"white"}}  size={this.state.tb.sizes[2]}>{this.props.panes['bottom']||null}</Pane>
        </SplitPane>
        <Pane maxSize={"0px"} style={{pointerEvents:"auto",background:"white"}} size={this.state.lr.sizes[2]}>{this.props.panes['right']||null}</Pane>
      </SplitPane>
    </SplitPaneStyled>
